...
@ignore
Cenário: Deve negar todos os steps "Dado" dos cenários anteriores     Dado que o ticket é CD123     Dado que o ticket é AG1234     Dado que o valor da passagem é R$ 1.1345,56     Dado que o nome do passageiro é "Beltrano Souza Matos de Alcântara Azevedo"     Dado que o telefone do passageiro é 1234-5678     Dado que o telefone do passageiro é 999-2223
